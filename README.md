...
```bash
$ LD_PRELOAD=$HOME/bin/lib/libuserhosts.so ping cryostat3
$ LD_PRELOAD=$HOME/bin/lib/libuserhosts.so curl http://cryostat3:8181
$ LD_PRELOAD=$HOME/bin/lib/libuserhosts.so firefox http://cryostat3:8181
```
